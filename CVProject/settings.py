...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'smtg')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.settings_context.settings_context',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'cvproject'),
        'USER': os.environ.get('POSTGRES_USER', 'cvuser'),
